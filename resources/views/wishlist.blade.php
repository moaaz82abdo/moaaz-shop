 ...
 <main class="pt-90">
    ...
    <section class="shop-checkout container">
      ...
      <div class="shopping-cart">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col-md-6">
                    <form action="{{route('wishlist.move',['rowId'=>$item->rowId])}}" method="post">
                        @csrf
                        <button type="submit" class="btn btn-success">Move to cart</button>
                    </form>
                </div>
                <div class="col-md-6">
                    <form action="{{route('wishlist.remove',['rowId'=>$item->rowId])}}" method="post" id="remove-cart">
                    @csrf
                    @method('delete')
                  <a href="javascript:void(0)" class="remove-cart" onclick="document.getElementById('remove-cart').submit();">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-danger">No items in wishlist</div>
                <a href="{{route('shop.index')}}" class="btn btn-warning"> Add to wishlist now</a>
            </div>
        </div>
        @endif
